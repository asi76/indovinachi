  ...
  return (
    <div className="h-screen bg-purple-900 flex flex-col items-center justify-center p-6 gap-6 overflow-hidden">
      ...
      <motion.form initial={{ y: 40, opacity: 0 }} animate={{ y: 0, opacity: 1 }} transition={{ delay: 0.15 }} onSubmit={join} className="w-full max-w-xs flex flex-col gap-4">
        <input
          className="w-full text-center text-5xl font-black bg-white rounded-2xl py-6 text-gray-800 tracking-[0.2em] shadow-xl focus:outline-none placeholder-light focus:ring-4 focus:ring-yellow-400"
          placeholder="CODICE"
          value={code}
